...
export function UploadStep({ file, loading, onFileSelect, onUpload }: UploadStepProps) {
  return (
    <section className="card">
      <h2 className="text-lg font-medium">1) Upload CSV file</h2>
      <p className="mt-1 text-sm text-slate-500">Select a CSV file to start the import flow. The original file will not be modified.</p>
